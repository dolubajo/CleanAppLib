...
namespace AppLib.Primitives
{
  public interface IMaybe<T> { }
  public class Nothing { }
  public class Nothing<T> : Nothing, IMaybe<T> { }
  ...
  public static class MaybeExtensions
  {
    ...
    public static IMaybe<T> apply<T>(this IMaybe<T> apply_to, Func<T, IMaybe<T>> function)
    {
      if (apply_to == null)
      {
    ...
    public static Q Match<P, Q>(this IMaybe<P> maybe, Func<P, Q> has_value, Func<Q> nothing)
    {
    ...
    public static P GetValueOrDefault<P>(this IMaybe<P> maybe, P default_value)
    {
      if (maybe is Just<P>)
      {
        var value = (Just<P>)maybe;
    ...
    public static bool has_been_decided<T>(this IMaybe<T> maybe)
    {

      return maybe != null;
    }

    public static IEnumerable<T> SelectJustValues<T>(this IEnumerable<IMaybe<T>> source)
    {
    ...
    public static IMaybe<T> to_maybe<T>(this T source) where T : class
    {
